...
namespace NongTrai
{
    public class ManagerGuide : Singleton<ManagerGuide>
    {
        ...
        public int GuideClickFieldHavestCrop
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickFieldHavestCrop") == false)
                    PlayerPrefs.SetInt("GuideClickFieldHavestCrop", 0);
                return PlayerPrefs.GetInt("GuideClickFieldHavestCrop");
            }
        ...
        public int GuideClickCutting
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickCutting") == false) PlayerPrefs.SetInt("GuideClickCutting", 0);
                return PlayerPrefs.GetInt("GuideClickCutting");
            }
        ...
        public int GuideClickFieldCrop
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickFieldCrop") == false) PlayerPrefs.SetInt("GuideClickFieldCrop", 0);
                return PlayerPrefs.GetInt("GuideClickFieldCrop");
            }
        ...
        public int GuideClickSeeds
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickSeeds") == false) PlayerPrefs.SetInt("GuideClickSeeds", 0);
                return PlayerPrefs.GetInt("GuideClickSeeds");
            }
        ...
        public int MoveCameraCageChicken
        {
            get
            {
                if (PlayerPrefs.HasKey("MoveCameraCageChicken") == false)
                    PlayerPrefs.SetInt("MoveCameraCageChicken", 0);
                return PlayerPrefs.GetInt("MoveCameraCageChicken");
            }
        ...
        public int GuideClickCageChicken
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickCageChicken") == false)
                    PlayerPrefs.SetInt("GuideClickCageChicken", 0);
                return PlayerPrefs.GetInt("GuideClickCageChicken");
            }
        ...
        public int GuideClickShopBuyChicken
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickShopBuyChicken") == false)
                    PlayerPrefs.SetInt("GuideClickShopBuyChicken", 0);
                return PlayerPrefs.GetInt("GuideClickShopBuyChicken");
            }
        ...
        public int GuideClickShopPetsBuyChicken
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickShopPetsBuyChicken") == false)
                    PlayerPrefs.SetInt("GuideClickShopPetsBuyChicken", 0);
                return PlayerPrefs.GetInt("GuideClickShopPetsBuyChicken");
            }
        ...
        public int GuideClickPetsBuyChicken
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickPetsBuyChicken") == false)
                    PlayerPrefs.SetInt("GuideClickPetsBuyChicken", 0);
                return PlayerPrefs.GetInt("GuideClickPetsBuyChicken");
            }
        ...
        public int GuideClickChicken
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickChicken") == false) PlayerPrefs.SetInt("GuideClickChicken", 0);
                return PlayerPrefs.GetInt("GuideClickChicken");
            }
        ...
        public int GuideClickFoodChicken
        {
            get
            {
                if (PlayerPrefs.HasKey("GuideClickFoodChicken") == false)
                    PlayerPrefs.SetInt("GuideClickFoodChicken", 0);
                return PlayerPrefs.GetInt("GuideClickFoodChicken");
            }
