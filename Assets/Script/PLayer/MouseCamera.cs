        ...
        void Update()
        {
            if (MainCamera.instance.camLock == false)
            {
                    ...
                    - mocRight.position.x >= 0)
                {
                    ...
                    float distanceSize = mcam.orthographicSize * ((float) Screen.width / Screen.height) +
                                         (mcam.orthographicSize - oldSize) * ((float) Screen.width / Screen.height);
                ...
                {
                    float oldSize = mcam.orthographicSize;
                    float distanceSize = mcam.orthographicSize +
                                         (mcam.orthographicSize - oldSize) * mcam.orthographicSize;
