    ...
    public class ManagerMarket : MonoBehaviour
    {
        ...
        public void ButtonChooseItemSale(int idStypeItem, int idItem)
        {
            ...
            switch (idTypeItemSale)
            {
                ...
                case 2:
                    if (Application.systemLanguage == SystemLanguage.Vietnamese)
                        NameItemSaleText.text = ManagerData.instance.facetoryItems.FacetoryItemDatas[idItemSale].name;
                    else if (Application.systemLanguage == SystemLanguage.Indonesian)
                        NameItemSaleText.text =
                            ManagerData.instance.facetoryItems.FacetoryItemDatas[idItemSale].nameINS;
                    else
                        NameItemSaleText.text =
                            ManagerData.instance.facetoryItems.FacetoryItemDatas[idItemSale].engName;
                    ItemSaleImage.sprite = ManagerData.instance.facetoryItems.FacetoryItemDatas[idItemSale].item;
        ...
        private void ShowGoldGotSale()
        {
            switch (idTypeItemSale)
            {
                ...
                case 1:
                    GoldGotSaleItem =
                        QuantitySaleItem * ManagerData.instance.petCollection.Pet[idItemSale].itemPet.sell;
                    break;
                case 2:
