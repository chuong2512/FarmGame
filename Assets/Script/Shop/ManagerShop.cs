...
public class ManagerShop : MonoBehaviour
{
    ...
    [Header("Name Shop")]
    [SerializeField] Text txtNameShopHome;
    ...
    [Header("Image Shop")]
    [SerializeField] Image[] StypeShop;

    [Header("Image Button Shop")]
    [SerializeField] Sprite[] ShopLock;
    [SerializeField] Sprite[] ShopSelect;

    [Header("SrollSnap")]
    public ScrollRect scrollRectCage;
    ...
    [Header("Buy Pets")]
    [HideInInspector] public int idPet;
    ...
    void updateField(int id)
    {
        ...
        infoField.info[id].levelOpen = infoField.info[id].levelOpen + ManagerData.instance.lands.Land[id].distanceLvOpen;
    ...
    void updateCage(int id)
    {
        ...
        infoCage.info[id].levelOpen = infoCage.info[id].levelOpen + ManagerData.instance.cages.Cage[id].distanceLvOpen;
    ...
    public void BuildFactory(int idFactory, int idProduct, Vector3 target)
    {
        ...
        GameObject factoryBuilding = Instantiate(Factory[idFactory], target, Quaternion.identity, parentFactory[idFactory]);
    ...
    void updateFactory(int id)
    {
        ...
        infoFactory.info[id].goldPrice = infoFactory.info[id].goldPrice * ManagerData.instance.facetorys.Facetory[id].mutiGold;
        ...
        infoFactory.info[id].levelOpen = infoFactory.info[id].levelOpen + ManagerData.instance.facetorys.Facetory[id].distanceLvOpen;
        PlayerPrefs.SetInt("levelOpenFactory" + id, infoFactory.info[id].levelOpen);
        infoFactory.info[id].total = infoFactory.info[id].total + ManagerData.instance.facetorys.Facetory[id].amountOpen;
    ...
    void updateTree(int id)
    {
        ...
        inforTree.info[id].goldPrice = (int)inforTree.info[id].goldPrice * ManagerData.instance.trees.data[id].Tree.mutiGold;
        ...
        inforTree.info[id].levelOpen = inforTree.info[id].levelOpen + ManagerData.instance.trees.data[id].Tree.distanceLvOpen;
    ...
    private void LoadData()
    {
        for (int i = 0; i < infoField.info.Length; i++)
        {
            ...
            else if (PlayerPrefs.HasKey("statusFieldStore" + i) == false)
            {
                ...
                if (infoField.info[i].levelOpen == Experience.instance.level)
                {
                    ...
                    infoField.info[i].levelOpen = infoField.info[i].levelOpen + ManagerData.instance.lands.Land[i].distanceLvOpen;
                    infoField.info[i].total = infoField.info[i].total + ManagerData.instance.lands.Land[i].amountOpen;
                    infoField.info[i].goldPrice = infoField.info[i].goldPrice * ManagerData.instance.lands.Land[i].purchase;
                    infoField.info[i].txtGoldPrice.text = "" + infoField.info[i].goldPrice;
                    infoField.info[i].icon.sprite = ManagerData.instance.lands.Land[i].iconStore;
                    if (Application.systemLanguage == SystemLanguage.Vietnamese)
                        infoField.info[i].txtInfo.text = "Đất trồng cây";
        ...
        for (int i = 0; i < infoCage.info.Length; i++)
        {
            ...
            {
                if (PlayerPrefs.GetInt("iconCage" + i) == 1) infoCage.info[i].icon.sprite = ManagerData.instance.cages.Cage[i].iconStore;
            ...
            else
            {
                ...
                if (infoCage.info[i].levelOpen == Experience.instance.level)
                {
                    ...
                    infoCage.info[i].levelOpen = infoCage.info[i].levelOpen + ManagerData.instance.cages.Cage[i].distanceLvOpen;
                    infoCage.info[i].total = infoCage.info[i].total + ManagerData.instance.cages.Cage[i].amountOpen;
                    infoCage.info[i].goldPrice = infoCage.info[i].goldPrice * ManagerData.instance.cages.Cage[i].purchase;
                    infoCage.info[i].txtGoldPrice.text = "" + infoCage.info[i].goldPrice;
        ...
        for (int i = 0; i < infoFactory.info.Length; i++)
        {
            ...
            if (PlayerPrefs.HasKey("statusFactoryStore" + i))
            {
                ...
                if (infoFactory.info[i].status == 0)
                {
                    if (Application.systemLanguage == SystemLanguage.Vietnamese)
                        ...
                        infoFactory.info[i].txtInfo.text = "Terbuka di level " + (infoFactory.info[i].levelOpen + 1);
            ...
            else
            {
                ...
                if (infoFactory.info[i].levelOpen == Experience.instance.level)
                {
                    ...
                    infoFactory.info[i].levelOpen = infoFactory.info[i].levelOpen + ManagerData.instance.facetorys.Facetory[i].distanceLvOpen;
                    infoFactory.info[i].total = infoFactory.info[i].total + ManagerData.instance.facetorys.Facetory[i].amountOpen;
                    infoFactory.info[i].goldPrice = infoFactory.info[i].goldPrice * ManagerData.instance.facetorys.Facetory[i].purchase;
                    infoFactory.info[i].txtGoldPrice.text = "" + infoFactory.info[i].goldPrice;
                    infoFactory.info[i].icon.sprite = ManagerData.instance.facetorys.Facetory[i].iconStore;
        ...
        for (int i = 0; i < inforTree.info.Length; i++)
        {
            ...
            else if (PlayerPrefs.HasKey("statusTreeStore" + i) == false)
            {
                ...
                if (inforTree.info[i].levelOpen == 0)
                {
                    ...
                    inforTree.info[i].levelOpen = inforTree.info[i].levelOpen + ManagerData.instance.trees.data[i].Tree.distanceLvOpen;
                    inforTree.info[i].total = inforTree.info[i].total + ManagerData.instance.trees.data[i].Tree.quantityOpen;
                    inforTree.info[i].goldPrice = inforTree.info[i].goldPrice * ManagerData.instance.trees.data[i].Tree.purchase;
                    inforTree.info[i].txtGoldPrice.text = "" + inforTree.info[i].goldPrice;
                    inforTree.info[i].icon.sprite = ManagerData.instance.trees.data[i].Tree.iconStore;
            ...
            if (PlayerPrefs.HasKey("statusDCRStore" + i) == false)
            {
                ...
                else if (inforDecorate.info[i].levelOpen != 0)
                {
                    if (Application.systemLanguage == SystemLanguage.Vietnamese)
                        ...
                        inforDecorate.info[i].txtInfo.text = "Terbuka di level " + (inforDecorate.info[i].levelOpen + 1);
                    else inforDecorate.info[i].txtInfo.text = "Unlock Level " + (inforDecorate.info[i].levelOpen + 1);
        ...
        for (int i = 0; i < inforFlowers.info.Length; i++)
        {
            if (PlayerPrefs.HasKey("updateFlowers" + i) == true)
            {
                if (PlayerPrefs.GetInt("updateFlowers" + i) == 1)
                {
                    ...
                    inforFlowers.info[i].sprRenderer.sprite = ManagerData.instance.flowers.Data[i].detailFlower.iconStore;
