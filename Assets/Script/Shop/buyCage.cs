namespace NongTrai
{
    ...
    public class buyCage : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler, IBeginDragHandler,
        IEndDragHandler
                ...
                switch (status)
                {
                    ...
                    case 1:
                        ...
                        if (eventData.pointerEnter == null)
                        {
                            status = 2;
                            Destroy(obj);
                            obj = Instantiate(ManagerShop.instance.Cage[idCage], targetOne, Quaternion.identity,
                                ManagerShop.instance.parentCage[idCage]);
