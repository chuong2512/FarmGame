...
public class buyPet : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    void Start()
    {
        ...
        if (idPet == 0 && ManagerGuide.instance.GuideClickPetsBuyChicken == 0) ManagerGuide.instance.CallArrowPetChicken();
    }
