...
namespace NongTrai
{
    public class ManagerGame : Singleton<ManagerGame>
    {
        ...
        [FormerlySerializedAs("MinX")] [SerializeField] Transform minX;
        [FormerlySerializedAs("MaxX")] [SerializeField] Transform maxX;
        [FormerlySerializedAs("MinY")] [SerializeField] Transform minY;
        [FormerlySerializedAs("MaxY")] [SerializeField] Transform maxY;
        [FormerlySerializedAs("EffectInGame")] [SerializeField] GameObject effectInGame;
