...
namespace NongTrai
{
    public class ManagerDepot : MonoBehaviour
    {
        ...
        public int levelDepot
        {
            get
            {
                if (!PlayerPrefs.HasKey("LevelDepot")) PlayerPrefs.SetInt("LevelDepot", 0);
                return PlayerPrefs.GetInt("LevelDepot");
            }
        ...
        public int capacity
        {
            get
            {
                if (!PlayerPrefs.HasKey("CapacityDepot")) PlayerPrefs.SetInt("CapacityDepot", 60);
                return PlayerPrefs.GetInt("CapacityDepot");
            }
        ...
        void Start()
        {
            if (levelDepot < 10)
            {
                ...
                {
                    Destroy(DepotHouse);
                    DepotHouse = Instantiate(ManagerData.instance.depot.Depot[levelDepot - 1].depot, transform.position,
                ...
                for (int i = 0; i < DataUpdate.metarial.Length; i++)
                {
                    ...
                    DataUpdate.metarial[i].QuantityItem =
                        ManagerData.instance.depot.Depot[levelDepot].metarial[i].QuantityItem;
                }
            }
