    ...
    public class GemFly : MonoBehaviour
    {
        ...
        void DrawQuadraticCurveExp()
        {
            for (int i = 1; i < numberPointsGem + 1; i++)
            {
                ...
                positionGem[i - 1] =
                    CalculateQuadraticBezierPoint(t, transform.position, pointerLeft.position, pointerGem.position);
            }
        }
        ...
        void ExpFly()
        {
            ...
            objGem.transform.position = Vector3.MoveTowards(objGem.transform.position, positionGem[indexArrayGem],
